...
.form-container {
    background-color: rgba(255, 255, 255, 0.2); /* Light background with 20% opacity */
    backdrop-filter: blur(3px); /* Slight blur for a frosted-glass effect */
    border-radius: 10px;
    padding: 20px;
    width: 60%;
    max-width: 600px;
    ...
    box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); /* Lighter shadow for subtle depth */
}
        ...
        label {
            font-weight: bold;
            color: #ecf0f1; /* Lighter color for labels */
        }
...
<h3 style="text-align: center; color: white;"><u>Faculty Registration</u></h3>
  ...
  <script>
    ...
    if (urlParams.has('success')) {
        ...
        window.location.href = "faclogin.jsp"; // Redirect to faclogin.jsp
    }
</script>
</body>
</html>
